...
public class IqcMcpServerController {
    ...
    @GetMapping @ResourcePermission(code="iqc:mcp:view", name="查看 MCP", type="iqc", description="查询 Agent MCP 资产") @Audit(operationType=OperationType.QUERY, description="查询 IQC MCP", module="IQC_MCP")
